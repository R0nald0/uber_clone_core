...
class AplicationBinding extends ApplicationBindings {
  ...
  List<Bind<Object>> bindings() => [
        ...
        Bind.lazySingleton((i) => StripeRestClientImpl()),
        Bind.lazySingleton((i)=> WhetherRestClientImpl()),  
        Bind.lazySingleton((i)=> IaRestClientImpl()),  
        ...
        Bind.lazySingleton<UberIaRepository>((i)=>UberIaRepositoryImpl(restClient: i())),  
        Bind.lazySingleton<IWheatherRepository>((i)=> WheatherRepositoryImpl(wheatherRestClient: i())),  
        ...
        Bind.lazySingleton<IaService>((i) => IaSerivceImpl(
          iaRepository: i(),
          locationRepositoryImpl:i() ,
          wheatherRepository: i()
          ))
      ];
}
